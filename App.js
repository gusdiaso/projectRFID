...
import { Alert, TouchableWithoutFeedback, Keyboard, KeyboardAvoidingView, Platform, View } from 'react-native';
...
export default function App() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        // await AsyncStorage.clear(); // Uncomment for debugging purposes
